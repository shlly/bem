	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <sec:authentication property="name" />
	                    ...
	                    <h2><span class="text-navy">goopay - 一个碉堡的公司</span>
	                   正在冉冉升起 <br/>三种皮肤自由切换.</h2>
	        ...
	        <div class="col-lg-6">
	            <div class="ibox float-e-margins">
	                <div class="ibox-content text-center p-md">
	                    ...
	                    <h4 class="m-b-xxs">基本左侧导航栏布局 </h4><small>(主要布局)</small>
	                    <p>可用的自定义选项</p>
	        ...
	        <div class="col-lg-6">
	            <div class="ibox float-e-margins">
	                <div class="ibox-content text-center p-md">
	                    ...
	                    <h4 class="m-b-xxs">全屏布局 <span class="label label-primary">NEW</span></h4>
	                    <small>(可选)</small>
	                    <p>可用的自定义选项</p>
	                    <span class="simple_tag">Scroll navbar</span>
	                    <span class="simple_tag">Boxed layout</span>
	        ...
	        <div class="col-lg-6">
	            <div class="ibox float-e-margins">
	                <div class="ibox-content text-center p-md">
	                    ...
	                    <h4 class="m-b-xxs">关闭菜单选项 <span class="label label-primary">NEW</span></h4>
	                    <small>(可选)</small>
	                    <p>可用的自定义选项</p>
	                    <span class="simple_tag">Collapse menu</span>
	                    <span class="simple_tag">Fixed sidebar</span>
