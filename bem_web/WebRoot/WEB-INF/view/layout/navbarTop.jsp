...
<div class="row border-bottom">
	...
	<div class="navbar-header">
	    ...
	    <ul class="nav navbar-top-links navbar-right">
	        <li>
	            <span class="m-r-sm text-muted welcome-message colorText">Welcome bem</span>
	        </li>
	        <%-- <li class="dropdown">
	        ...
	        <li>
	            <a href="javascript:logout('<%=basePath%>logout');" class="logout">
	                <i class="fa fa-sign-out"></i>登出/Logout
	            </a>
	        </li>
	    </ul>
